...
exports.startVM = function(id,tr,lang1,lang2,text){
    ...
    exec('ansible-playbook VMcreation.yml --extra-vars "ID=' + id + '"', (err, stdout, stderr) => {
      ...
      console.log(stdout)
      console.log("StartVM")
      exec('ansible-playbook VMstart.yml --extra-vars "tr_ID=' + tr  +' lang1=' + lang1  +' lang2=' + lang2  +' text=\'' + text +'\'"   -i hosts.' + id, (err, stdout, stderr) => {
          if (err) {
            console.error(err);
            return;
          }
